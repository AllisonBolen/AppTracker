...
public class Settings_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button notifications_button = findViewById(R.id.notif_button);
        notifications_button.setOnClickListener(v->{
            Intent notif_activity = new Intent(this, NotificationsActivity.class);
            startActivity(notif_activity);
        });
